        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpeedCompatibility = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BoostCompatible = table.Column<bool>(type: "bit", nullable: true),
                    TubelessReady = table.Column<bool>(type: "bit", nullable: true),
                    AxleStandard = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SuspensionTravel = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DeliveryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderId = table.Column<int>(type: "int", nullable: false),
                    LalamoveReference = table.Column<string>(type: "nvarchar(max)", nullable: true),
