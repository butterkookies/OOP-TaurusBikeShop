...
%% PAYMENT TYPES
B10 -->|Cash on Delivery| B14[Submit Order]
...
class A2,A6,A11,B4,B6,B12,B13,C2,D3,E2,BINV decision
class A1,A3,A5,A9,A10,B1,B2,B3,B7,B8,B9,B10,B18,C1,C3,D1,D2,E1,E3,E4,E5,E6,F1 io
class DB1,DB2,DB3,DB4 database
class EXT1 external
class C0,C1,C2,C3,C4,C5,D1,D2,D3,D4,E1,E2,E3,E4,E5,E6,F1 admin
class B14,B15,B16,B17,B18 order
class Z1 cancel
```