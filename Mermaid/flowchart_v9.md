...
A12 --> A11
A11 -->|No| A9
A11 -->|Yes| A13[Login Success]

%% =====================
%% SHOPPING FLOW
%% =====================
A13 --> B1[/View Product Catalog/]
B1 --> DB2
...
B22 -->|LBC| B23
B21 --> B10[Confirm Payment Method]
B23 --> B10
...
class Z1 cancel
class A4,A7,A12,A13,B5,B14,B15,B16,B17,B18,B27,D4,W4,W10,W11 process
...
class C0,C1,C2,C3,C4,C5,D1,D2,D3,D4,F1,W1,W2,W3,W4,W5,W6,W7,W8,W9,W10,W11,E1,H1 admin