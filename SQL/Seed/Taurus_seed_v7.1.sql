...
-- =============================================================================
-- B. USER
-- Password hashes are bcrypt placeholders — never real passwords.
-- =============================================================================
INSERT INTO [User] (Email, PasswordHash, FirstName, LastName, PhoneNumber, IsActive, IsWalkIn) VALUES
    ('admin@taurusbikes.com',   '$2b$12$ADMIN_HASH',    'Marco',  'Reyes',   '09171110001', 1, 0),  -- UserId=1
    ('cashier@taurusbikes.com', '$2b$12$CASHIER_HASH',  'Carlo',  'Santos',  '09173330003', 1, 0),  -- UserId=2
    ('juan.dc@email.com',       '$2b$12$CUSTOMER1_HASH','Juan',   'DelaCruz','09181234567', 1, 0),  -- UserId=3
    ('maria.g@email.com',       '$2b$12$CUSTOMER2_HASH','Maria',  'Garcia',  '09189876543', 1, 0),  -- UserId=4
